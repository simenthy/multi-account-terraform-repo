# =============================================================================
# Root variable declarations for the devops account.
# =============================================================================
# Mirrors accounts/nft/variables.tf exactly — same module shape, same
# cross-domain *_key(s) convention. aws_region and common_tags are declared
# ONCE here; every other variable is unique to its domain.
#
# Values arrive from the auto-loaded data files:
#   common.auto.tfvars  networking.auto.tfvars  security.auto.tfvars
#   compute.auto.tfvars  data.auto.tfvars  observability.auto.tfvars
# =============================================================================
